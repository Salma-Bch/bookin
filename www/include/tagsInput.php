<div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
    <?php
        ...
        while ( ($lineCsv = fgetcsv($csvFile,1024, ";")) !== FALSE ) {
            ...
            echo "<input type='checkbox' class='btn-check tags_input' value ='".strtolower(utf8_encode($lineCsv[0]))."' name='tags[".$i."]'id='".strtolower(utf8_encode($lineCsv[0]))."' autocomplete='off'>";
