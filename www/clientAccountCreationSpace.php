                    ...
                    <div id="firstPart">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input type='text' name="lastName" class='form-control' placeholder='Nom' onblur="validInput(this)"/>
                            ...
                            <div class="form-group col-md-6">
                                <input type='text' name="firstName" class='form-control' placeholder='Prénom' onblur="validInput(this)"/>
                                <div class="invalid-feedback" style="display: none">
                                    <p>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
                                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <input type='text' name="mail" class='form-control' placeholder='Adresse mail' onblur="validEmailInput(this)"/>
                                <div class="invalid-feedback" style="display: none">
                                    <p>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
                                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input type='password' name="psd" id="passwordInput" class='form-control' placeholder='Mot de passe' onblur="validInput(this)"/>
