...
<div class ='container-connexion'>
    <div class='card card-container-mdp'>
        <h2 class="mb-5 mt-5" style="margin-left: 0;">Création d'un compte administrateur Book'In</h2>
        <form id ="compteAdministratorInfo" class="form-group" method="post" onsubmit="return false">
            <div id="adm">
                <div class="row">
                ...
                <div class="form-group col-md-12">
                    <div class="row">
                        <div class="form-group col-sm-6 col-xs-6 partButton">
                            <button class='btn btn-lg btn-danger btn-block btn-signin' name="submit"  onclick="location.href='./administratorSpace.php'">Retour</button>
                        </div>
                        <div class="form-group col-sm-6 col-xs-6 partButton">
                            <button class='btn btn-lg btn-danger btn-block btn-signin' name="submit"  onclick="createAdministratorCompte('compteAdministratorInfo')">Creer mon compte</button>
                        </div>
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <p>Vous possédez déjà un compte ? <a href='administratorLoginSpace.php'>Identifiez-vous</a></p>
                </div>
            </div>
        </form>
    </div>
